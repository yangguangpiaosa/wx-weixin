...
<div class="page">
    <div class="page__hd">
        <h1 class="page__title">
            <img src="<%=request.getContextPath() %>/weui/example/images/logo.png" alt="WeUI" height="21px" />
        </h1>
        ...
        <ul>
            <li>
                <div class="weui-flex js_category">
                    ...
                    <img src="<%=request.getContextPath() %>/weui/example/images/icon_nav_form.png" alt="">
                </div>
            ...
            <li>
                <div class="weui-flex js_category">
                    ...
                    <img src="<%=request.getContextPath() %>/weui/example/images/icon_nav_layout.png" alt="">
                </div>
                <div class="page__category js_categoryInner">
                    <div class="weui-cells page__category-content">
            ...
            <li>
                <div class="weui-flex js_category">
                    ...
                    <img src="<%=request.getContextPath() %>/weui/example/images/icon_nav_feedback.png" alt="">
                </div>
                <div class="page__category js_categoryInner">
                    <div class="weui-cells page__category-content">
            ...
            <li>
                <div class="weui-flex js_category">
                    ...
                    <img src="<%=request.getContextPath() %>/weui/example/images/icon_nav_nav.png" alt="">
                </div>
                <div class="page__category js_categoryInner">
                    <div class="weui-cells page__category-content">
            ...
            <li>
                <div class="weui-flex js_category">
                    ...
                    <img src="<%=request.getContextPath() %>/weui/example/images/icon_nav_search.png" alt="">
                </div>
                <div class="page__category js_categoryInner">
                    <div class="weui-cells page__category-content">
            ...
            <li>
                <div class="weui-flex js_item" data-id="layers">
                    ...
                    <img src="<%=request.getContextPath() %>/weui/example/images/icon_nav_z-index.png" alt="">
                </div>
            </li>
        </ul>
    </div>
    <div class="page__ft">
        <a href="javascript:home()"><img src="<%=request.getContextPath() %>/weui/example/images/icon_footer.png" /></a>
    </div>
</div>
...
<div class="page">
    ...
    <div class="page__ft">
        <a href="javascript:home()"><img src="<%=request.getContextPath() %>/weui/example/images/icon_footer_link.png" /></a>
    </div>
</div>
</script>
    ...
    <div class="page__bd">
        ...
        <div class="weui-cells weui-cells_form">
            ...
            <div class="weui-cell weui-cell_vcode">
                ...
                <div class="weui-cell__ft">
                    <img class="weui-vcode-img" src="<%=request.getContextPath() %>/weui/example/images/vcode.jpg" />
                </div>
            </div>
        </div>
        ...
        <article class="weui-article">
            ...
            <section>
                ...
                <section>
                    ...
                    <p>
                        <img src="<%=request.getContextPath() %>/weui/example/images/pic_article.png" alt="">
                        <img src="<%=request.getContextPath() %>/weui/example/images/pic_article.png" alt="">
                    </p>
                </section>
                <section>
            ...
            <div class="weui-tabbar">
                <a href="javascript:;" class="weui-tabbar__item weui-bar__item_on">
                    <span style="display: inline-block;position: relative;">
                        <img src="<%=request.getContextPath() %>/weui/example/images/icon_tabbar.png" alt="" class="weui-tabbar__icon">
...
<div class="page">
    ...
    <div class="weui-gallery" style="display: block">
        <span class="weui-gallery__img" style="background-image: url(<%=request.getContextPath() %>/weui/example/images/pic_article.png);"></span>
                    ...
                    <div class="weui-uploader">
                        ...
                        <div class="weui-uploader__bd">
                            <ul class="weui-uploader__files" id="uploaderFiles">
                                <li class="weui-uploader__file" style="background-image:url(<%=request.getContextPath() %>/weui/example/images/pic_160.png)"></li>
                                <li class="weui-uploader__file" style="background-image:url(<%=request.getContextPath() %>/weui/example/images/pic_160.png)"></li>
                                <li class="weui-uploader__file" style="background-image:url(<%=request.getContextPath() %>/weui/example/images/pic_160.png)"></li>
                                <li class="weui-uploader__file weui-uploader__file_status" style="background-image:url(<%=request.getContextPath() %>/weui/example/images/pic_160.png)">
    ...
    <div class="weui-grids">
        <a href="javascript:;" class="weui-grid">
            <div class="weui-grid__icon">
                <img src="<%=request.getContextPath() %>/weui/example/images/icon_tabbar.png" alt="">
            </div>
...
<script type="text/javascript">
    ...
    <script src="<%=request.getContextPath() %>/weui/example/zepto.min.js"></script>
    <script type="text/javascript" src="https://res.wx.qq.com/open/js/jweixin-1.0.0.js"></script>
    <script src="<%=request.getContextPath() %>/weui/example/weui.min.js"></script>
    <script src="<%=request.getContextPath() %>/weui/example/example.js"></script>
</body>
</html>
